    ...
    return (
        <>
            <div className="flex gap-12 justify-between p-2 md:p-8">
                <h1 className="text-3xl"><Link href={"/blog/page/1"} className={page == "blog" ? 'underline' : null}>shoma</Link></h1>
                ...
                <ul className="flex gap-4 text-3xl">
                    ...
                    <li><Link href={"/"} className={page == "about" ? 'underline' : null}>about</Link></li>
                </ul>
            </div>
        </>
    )
